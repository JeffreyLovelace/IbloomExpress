...
export class AdministradorService {
  ...
  save(data:any): Observable<any> {
    let headers = new HttpHeaders().set('Authorization','Bearer ');
    return this.httpClient.post(this.API_ENDPOINT+`/administrador`,data,{headers: headers});
  }
  actualizar(id:any,data:any): Observable<any> {
    ...
    return this.httpClient.put(this.API_ENDPOINT+`/administrador/`+id,data,{headers: headers});
  }
  get(): Observable<any> {
    const headers = new HttpHeaders( {'Content-Type': 'application/json','X-Requested-With':'XMLHttpRequest', 'Authorization': 'Bearer '+localStorage.getItem("token")});
    return this.httpClient.get(this.API_ENDPOINT+`/administrador`,{headers: headers});
  }
  detalle(id:any): Observable<any> {
    const headers = new HttpHeaders( {'Content-Type': 'application/json','X-Requested-With':'XMLHttpRequest', 'Authorization': 'Bearer '+localStorage.getItem("token")});
    return this.httpClient.get(this.API_ENDPOINT+`/administrador/`+id,{headers: headers});
  }
